...
class Structure(val main: Control) extends ModelComponent {
  ...
  def init() {
    registerOperation(new StructureOperation.NaiveStrongBisimAnalyzer)
//    registerOperation(new StructureOperation.NaiveDivergenceMarker)
    
//    registerOperation(new StructureOperation.SchematicSimilarityAnalyzer)
    registerOperation(new StructureOperation.RefinedSimilarityAnalyzer)
//    registerOperation(new StructureOperation.BasicSASimilarityAnalyzer)
//    registerOperation(new StructureOperation.RefinedSASimilarityAnalyzer)
//    registerOperation(new StructureOperation.SASimilarityAnalyzer) // does not yet work!
    
    registerOperation(new StructureOperation.BasicSAWeakSimilarityAnalyzer)
    
//    registerOperation(new StructureOperation.SchematicCoupledSimilarityAnalyzer)
    registerOperation(new StructureOperation.FixedPointCoupledSimilarityAnalyzer)
//    registerOperation(new StructureOperation.BasicSACoupledSimilarityAnalyzer)
    ...
    registerOperation(new StructureOperation.TauClosureCoupledSimilarityAnalyzer)
    registerOperation(new StructureOperation.NaiveCoupledSimChecker)
...
//    registerOperation(new StructureOperation.RemoveTauEndoSteps)
//    registerOperation(new StructureOperation.InstableStateRemover)
    
    registerOperation(new StructureOperation.WeakStepRelationClosure)
    registerOperation(new StructureOperation.AGraphConstructor)
    registerOperation(new StructureOperation.PS94CSNormalizer)
